...
public class CodeGenerator {
    ...
    private static void executeCode(String pack,String[] tables) {
        ...
        gc.setOutputDir(projectPath + "/backend/src/test/java");
        //设置bean命名规范
        gc.setEntityName("%s");
        // 开发人员
        gc.setAuthor("~");
        ...
        // 从试图获取
        config.setUrl("jdbc:mysql://localhost:3306/delivery");
        ...
        focList.add(new FileOutConfig("/templates/mapper.xml.ftl") {
            ...
            public String outputFile(TableInfo tableInfo) {
                ...
                if (StringUtils.isEmpty(pc.getModuleName())) {
                    return projectPath + "/backend/src/main/resources/mapper/" + tableInfo.getXmlName() + StringPool.DOT_XML;
                }else {
                    return projectPath + "/backend/src/main/resources/mapper/" + pc.getModuleName() + "/" + tableInfo.getXmlName() + StringPool.DOT_XML;
                }
            }
        });
