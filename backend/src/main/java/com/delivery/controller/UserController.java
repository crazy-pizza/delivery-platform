...
public class UserController {
    ...
    @ApiOperation("查询用户")
    @PostMapping("/select")
    public IPage<User> select(@RequestBody User user) {
    ...
    @ApiOperation("登陆")
    @PostMapping("/login")
    public User login(@Valid @RequestBody User user, @ApiIgnore HttpSession session) {
    ...
    @ApiOperation("登出")
    @PostMapping("/logout")
    public void logoff(@ApiIgnore HttpSession session) {
